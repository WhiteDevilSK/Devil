                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '🔰Main Channel🔰', url="https://t.me/TeamMC1"
                                )
                        ]
                    ]
                )
...
async def about(bot, update):
    ...
    buttons = [[
        ...
        InlineKeyboardButton('👤 Black Devil Devil 👤', url='https://t.me/sk_the_white_Devil')
    ],[
